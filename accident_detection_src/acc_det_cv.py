...
def detect_changes(pr_lst, frame2, minio_client, bucketname, collection, change_threshold):
    ...
    if max_max_contour is not None:
        ...
        cv2.putText(frame2, f'Frame Area: {total_pixels} px', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 0), 1, cv2.LINE_AA)
        cv2.putText(frame2, f'Bounding Box Area: {fin_cumulative_area} px', (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 0), 1, cv2.LINE_AA)

        # Display percentage of pixels changed
        cv2.putText(frame2, f'Change: {avg_percentage_changed:.2f}%', (10, 110), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 1, cv2.LINE_AA)
    ...
    cv2.putText(frame2, f'Biggest Change: {biggest_percentage_change:.2f}%', (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 1, cv2.LINE_AA)
    det=0
